...
class RulesCommand extends PluginCommand {
	public function __construct(Main $owner) {
		parent::__construct($this->getPlugin()->getLanguage()->get("rules.name"), $owner);
		$this->setUsage($this->getPlugin()->getLanguage()->get("rules.usage"));
		$this->setPermission("core.command.rules");
		$this->setDescription($this->getPlugin()->getLanguage()->get("rules.desc"));
	}
